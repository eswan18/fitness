...
def mileage_by_shoes(runs: list[Run], include_retired: bool = False, retirement_service: RetirementService | None = None) -> dict[str, float]:
    """
...
def mileage_by_shoes_with_retirement(runs: list[Run], retirement_service: RetirementService | None = None) -> dict[str, dict]:
    """
    ...
    for shoe_name, total_mileage in mileage.items():
        ...
        result[shoe_name] = {
            ...
            'retirement_date': retirement_info.retirement_date if retirement_info else None,
